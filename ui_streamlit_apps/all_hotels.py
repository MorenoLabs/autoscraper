"""
Hotel Risk Analysis System
-------------------------

This script creates a Streamlit web application that analyzes hotel review data to generate
risk scores based on multiple factors. It provides both individual hotel analysis and
batch processing capabilities.

Key Features:
- Calculates comprehensive risk scores based on multiple metrics:
  * Basic performance metrics (average rating, standard deviation)
  * Performance deviation from overall mean
  * Guest type adaptability
  * Seasonal variations
  * Rating stability
  * Room type variation
...
Core Components:
- analyze_single_hotel(): Performs detailed analysis for individual hotels
- main(): Handles the Streamlit UI and file processing

Input:
- CSV file containing hotel reviews with columns:
  * hotel_name
  * rating
  * review_post_date
  * stay_type
...
- Downloadable CSV with risk scores for all hotels
